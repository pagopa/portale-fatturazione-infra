...
| <a name="module_tlscert-api-portalefatturazione-pagopa-it-cert_az"></a> [tlscert-api-portalefatturazione-pagopa-it-cert\_az](#module\_tlscert-api-portalefatturazione-pagopa-it-cert\_az) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_tls_cert_federated | v4.1.3 |
| <a name="module_tlscert-portalefatturazione-pagopa-it-cert_az"></a> [tlscert-portalefatturazione-pagopa-it-cert\_az](#module\_tlscert-portalefatturazione-pagopa-it-cert\_az) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_tls_cert_federated | v4.1.3 |
...
| <a name="input_prod_identity_rg_name"></a> [prod\_identity\_rg\_name](#input\_prod\_identity\_rg\_name) | PROD Managed Identity resource group name | `string` | n/a | yes |
...
| <a name="input_tlscert-api-portalefatturazione-pagopa-it"></a> [tlscert-api-portalefatturazione-pagopa-it](#input\_tlscert-api-portalefatturazione-pagopa-it) | n/a | `map` | <pre>{<br>  "pipeline": {<br>    "dns_record_name": "api",<br>    "dns_zone_name": "portalefatturazione.pagopa.it",<br>    "enable_tls_cert": true,<br>    "path": "TLS-Certificates",<br>    "variables": {<br>      "CERT_NAME_EXPIRE_SECONDS": "2592000"<br>    },<br>    "variables_secret": {}<br>  },<br>  "repository": {<br>    "branch_name": "refs/heads/master",<br>    "name": "le-azure-acme-tiny",<br>    "organization": "pagopa",<br>    "pipelines_path": "."<br>  }<br>}</pre> | no |
| <a name="input_tlscert-portalefatturazione-pagopa-it"></a> [tlscert-portalefatturazione-pagopa-it](#input\_tlscert-portalefatturazione-pagopa-it) | n/a | `map` | <pre>{<br>  "pipeline": {<br>    "dns_record_name": "",<br>    "dns_zone_name": "portalefatturazione.pagopa.it",<br>    "enable_tls_cert": true,<br>    "path": "TLS-Certificates",<br>    "variables": {<br>      "CERT_NAME_EXPIRE_SECONDS": "2592000"<br>    },<br>    "variables_secret": {}<br>  },<br>  "repository": {<br>    "branch_name": "refs/heads/master",<br>    "name": "le-azure-acme-tiny",<br>    "organization": "pagopa",<br>    "pipelines_path": "."<br>  }<br>}</pre> | no |
