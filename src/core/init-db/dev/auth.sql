...
-- fat-d-adgroup-admin --
SET @user = 'fat-d-adgroup-admin'
EXEC CreateUser @user
EXEC AddRoleToUser @user, 'db_owner'

-- fat-d-adgroup-developers --
SET @user = 'fat-d-adgroup-developers'
EXEC CreateUser @user
...
-- fat-d-api-func --
SET @user = 'fat-d-api-func'
EXEC CreateUser @user
EXEC AddRoleToUser @user, 'db_datareader'
EXEC AddRoleToUser @user, 'db_datawriter'

-- fat-d-integration-func --
SET @user = 'fat-d-integration-func'
EXEC CreateUser @user
EXEC AddRoleToUser @user, 'db_datareader'
EXEC AddRoleToUser @user, 'db_datawriter'
